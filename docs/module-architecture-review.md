...
> **注記（2026-09-17）**: 本文書の指摘 1〜3 は既に解消済みで、内容は現状と乖離しています。
> 後継として [improvement-proposal-2026-09.md](improvement-proposal-2026-09.md) を参照してください。
> 未解消の指摘（4: UseCase の配置、5: `tyhoon` ディレクトリの typo）も後継文書に引き継いでいます。
